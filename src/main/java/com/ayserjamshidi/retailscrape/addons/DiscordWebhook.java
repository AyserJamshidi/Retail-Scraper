package com.ayserjamshidi.retailscrape.addons;
...
/*public static void thing() {
		try {
			com.ayserjamshidi.retailscrape.addons.DiscordWebhook webhook = new com.ayserjamshidi.retailscrape.addons.DiscordWebhook("https://discord.com/api/webhooks/774850994286624768/-4obrF_fFMdKvsOfJNLMyPa8e2bCa1ggw3X2Rt_QCNhYwhaIl6JBTTYS1Ho22-u5Sl_l");
			webhook.setContent("Any message!");
			webhook.setAvatarUrl("https://your.awesome/image.png");
			webhook.setUsername("Custom Usernames!");
			webhook.setTts(true);
			webhook.addEmbed(new com.ayserjamshidi.retailscrape.addons.DiscordWebhook.EmbedObject()
					.setTitle("Title")
...
public class DiscordWebhook {
    ...
    /**
     * Constructs a new com.ayserjamshidi.retailscrape.addons.DiscordWebhook instance
     *
    ...
    public void execute() throws IOException {
        ...
        connection.addRequestProperty("User-Agent", "Java-com.ayserjamshidi.retailscrape.addons.DiscordWebhook-BY-Gelox_");
